...
#             if current_node.val not in new_nodes:
#                 new_nodes[current_node.val] = Node(current_node.val)
    ...
    def cloneGraph(self, node: Optional['Node']) -> Optional['Node']:
        ...
        def clone(node: Optional['Node']):
            ...
            for n in node.neighbors:
                if n.val not in new_nodes:
                    new_nodes[n.val] = Node(n.val)
                new_nodes[n.val].neighbors.append(new_nodes[node.val])
